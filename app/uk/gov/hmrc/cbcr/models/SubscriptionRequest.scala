...
object PhoneNumber {
  ...
  implicit val format: Format[PhoneNumber] = new Format[PhoneNumber] {
    override def writes(o: PhoneNumber): JsValue = JsString(o.number)
...
object ContactDetails {
  ...
  val emailFormat: Format[EmailAddress] = new Format[EmailAddress] {
    override def writes(o: EmailAddress): JsValue = Json.obj("emailAddress" -> o.value)
...
object SubscriptionRequest {
  val subscriptionWriter: Writes[SubscriptionRequest] = new Writes[SubscriptionRequest] {
    override def writes(o: SubscriptionRequest): JsValue = Json.obj(
      "safeId"            -> o.safeId,
...
object GetResponse {
  ...
  private val grReads: Reads[GetResponse] = ((JsPath \ "safeId").read[String] and
  ...
  implicit val format: Format[GetResponse] = new Format[GetResponse] {
    override def writes(o: GetResponse): JsValue = Json.obj(
      "safeId"  -> o.safeId,
